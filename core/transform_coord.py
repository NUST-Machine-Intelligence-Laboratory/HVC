...
#_tv_interpolation_to_str = {
#    Image.NEAREST: 'IM.NEAREST',
#    Image.BILINEAR: 'IM.BILINEAR',
#    Image.BICUBIC: 'IM.BICUBIC',
#    Image.LANCZOS: 'IM.LANCZOS',
#    Image.HAMMING: 'IM.HAMMING',
#    Image.BOX: 'IM.BOX',
#}
...
class RandomResizedCropCoord(object):
    ...
    def __init__(self, size, scale=(0.08, 1.0), ratio=(3. / 4., 4. / 3.), interpolation=IM.BILINEAR):
